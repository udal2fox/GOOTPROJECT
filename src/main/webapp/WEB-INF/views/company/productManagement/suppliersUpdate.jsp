					...
					<tr>
						...
						<td>
							<c:choose> 
								...
								<c:otherwise>
									<input class="form-check-input" type="radio" name="supsBnt" id="exampleRadios1" value="법인">
									<label class="form-check-label" for="exampleRadios1">법인</label>
							    </c:otherwise>
  						  	</c:choose>
						</td> 	
						<td>
							<c:choose> 
								<c:when test="${GSV.supsBnt eq '법인'}">
									<input class="form-check-input" type="radio" name="supsBnt" id="exampleRadios1" value="개인" checked>
						...
						<td>
							<c:choose> 
								<c:when test="${GSV.supsSt eq '거래중'}">
									<input class="form-check-input" type="radio" name="supsSt" id="exampleRadios1" value="거래중" checked>
									<label class="form-check-label" for="exampleRadios1">거래중</label>
								</c:when>
								<c:otherwise>
									<input class="form-check-input" type="radio" name="supsSt" id="exampleRadios1" value="거래중">
									<label class="form-check-label" for="exampleRadios1">거래중</label>
							    </c:otherwise>
  						  	</c:choose>
						</td> 	
						...
						<c:choose> 
							<c:when test="${GSV.supsSt eq '거래중단'}">
								<input class="form-check-input" type="radio" name="supsSt" id="exampleRadios1" value="거래중단" checked>
								<label class="form-check-label" for="exampleRadios1">거래중단</label>
							</c:when>
							<c:otherwise>
								<input class="form-check-input" type="radio" name="supsSt" id="exampleRadios1" value="거래중단">
								<label class="form-check-label" for="exampleRadios1">거래중단</label>
						    </c:otherwise>
					  	</c:choose>
						</td>	
