	...
	<div class="container-fluid" align="center">
			...
			<tr>
				...
				<td colspan="4">
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="기업">
						<label class="form-check-label" for="inlineRadio1">기업</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="지점">
						<label class="form-check-label" for="inlineRadio2">지점</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="거래명세서">
		...
		<table border="1" class="saleStatsTableInfo">
			...
			<c:forEach var="uc" items="${ucList}">
				<tr class="td" data-type="${uc.comBizType}" data-status="${uc.recSortation}">
