			...
			<thead>
				  <tr>
			          ...
			          <td style="text-align: left;">
			             <input type="text" class="searchBarKeyword" id="keyword" name="searchBarKeyword" placeholder="기업명/사업자번호/이메일/연락처" style="text-align: center; width: 300px;">
			          </td> 
			          <td></td>
			          <td></td>
			       </tr>
			       <tr>
					<td class="searchBar_tbl_title" style="text-align: left;">기업 구분</td>
					<td> 
